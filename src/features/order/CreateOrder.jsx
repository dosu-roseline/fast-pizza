      ...
      <Form method="POST" action="/order/new">
        ...
        <div className="mb-5 flex gap-2 sm:flex-row sm:items-center">
          ...
          <div className="grow">
            ...
            {formErrors?.phone && (
              <p className="mt-2 text-xs bg-red-100 rounded-md text-red-700 p-2">
                {formErrors.phone}
              </p>
            )}
          </div>
        ...
        <div className="mb-5 flex gap-2 sm:flex-row sm:items-center relative">
        ...
        <div className="mb-12 flex gap-5">
          ...
          />
          <label className="sm:basis-40" htmlFor="priority">
